...
OUTPUT=paperdata/large_V1N2M4.csv
rm -rf $OUTPUT
# rm -rf ${TARGET_DIR}/*
...
echo "./spmm --mtxfile ${TARGET_DIR}/${filename[$i]}.mtx --outmtxfile outmtx/tmp.mtx --maxiter 10 --n 64 --sched 0 --v 1"
printf "${filename[$i]}, " >> ${OUTPUT}
./spmm --mtxfile ${TARGET_DIR}/${filename[$i]}.mtx --outmtxfile outmtx/tmp.mtx --maxiter 10 --n 64 --sched 0 --v 1 >> ${OUTPUT}
